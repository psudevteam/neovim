...
_G.packer_plugins = {
  ...
  ["coq.artifacts"] = {
    loaded = true,
    path = "/home/ms/.local/share/nvim/site/pack/packer/start/coq.artifacts",
  ...
  coq_nvim = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/home/ms/.local/share/nvim/site/pack/packer/opt/coq_nvim",
  ...
  ["vim-floaterm"] = {
    loaded = true,
    path = "/home/ms/.local/share/nvim/site/pack/packer/start/vim-floaterm",
